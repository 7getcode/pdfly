...
export default function Index() {
  // hold for 5 seconds to see loading animation set using tanstack router
  return (
    <>
      {/* <DummyContent /> */}
    </>
...
const navItems = [
  { label: "Home", to: "/" },
  { label: "Prfffojects", to: "/projects" },
  { label: "Contact", to: "/contact" },
];

export function DockNavMenu() {
  return (
    <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white/80 dark:bg-black/80 backdrop-blur-lg rounded-xl px-4 py-2 shadow-lg z-50">
